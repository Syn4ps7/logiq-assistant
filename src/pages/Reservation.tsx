...
// TVA 8.1 %. Quota km calé sur la CGL Art. 14.10 (200 km/jour pour les Carnets Pro).
const CARNETS: { id: CarnetId; days: number; totalHT: number; totalTTC: number; perDayHT: number; perDayTTC: number; kmPerDay: number }[] = [
  { id: "carnet-10", days: 10, totalHT: 1450, totalTTC: 1567.45, perDayHT: 145, perDayTTC: 156.75, kmPerDay: 200 },
  { id: "carnet-20", days: 20, totalHT: 2600, totalTTC: 2810.60, perDayHT: 130, perDayTTC: 140.55, kmPerDay: 200 },
  { id: "carnet-40", days: 40, totalHT: 4800, totalTTC: 5188.80, perDayHT: 120, perDayTTC: 129.70, kmPerDay: 200 },
];
