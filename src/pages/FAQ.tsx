...
const faqs: FaqItem[] = [
  ...
  { q: "Le véhicule est-il assuré ?", a: "Oui, tous nos véhicules incluent l'assurance responsabilité civile (RC). La franchise standard est de 2'000 CHF, réductible à 500 CHF avec l'option Sérénité (59 CHF/location). Certaines situations sont exclues de toute garantie (CGL, {Art. 7|article-7})." },
